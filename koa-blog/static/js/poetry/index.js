                ...
                <ol class="poetry-list">
                    <template v-if="!search.status">
                        <li>
                            <p>每日精选诗词</p>
                            <ul>
                                <li class="poetry-list-title" @click="menuFn(500)" @click="showInfo(choice)" >
                                    <span>{{choice[5]}}</span>
                                    <span>{{choice[2]}}</span>
                                </li>
                            </ul>
                        ...
                        <li v-for="(item,index) in info">
                            <template v-if="item[4].length">
                                <p v-text="item[0]" ></p>
                                <ul>
                                    <li @click="menuFn(500)" class="poetry-list-title" v-for="item2 in item[4]" @click="showInfo(item2)" >
                                        <span>{{item2[5]}}</span>
                                        <span>{{item2[2]}}</span>
                                    </li>
                                </ul>
                    ...
                    <template v-else>
                        <li @click="menuFn(500)" class="poetry-list-title" v-for="item in search.info"  @click="showInfo(item)" >
                            <span>{{item[5]}}</span>
                            <span>{{item[2]}}</span>
                        </li>
                    </template>
